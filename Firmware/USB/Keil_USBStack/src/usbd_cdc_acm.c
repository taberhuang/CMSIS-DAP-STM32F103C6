...
void USBD_CDC_ACM_EP_INTIN_Event (U32 event) {
...
void USBD_CDC_ACM_EP_BULKOUT_Event (U32 event) {
...
void USBD_CDC_ACM_EP_BULKIN_Event (U32 event) {
...
void USBD_CDC_ACM_EP_BULK_Event (U32 event) {
