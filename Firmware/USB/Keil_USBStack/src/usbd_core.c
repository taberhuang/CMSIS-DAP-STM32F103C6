...
/* GCC does not support ARMCC's `__asm void $$USBD$$version` with EXPORT/EQU.
 * Provide the version symbol as a plain C constant instead. */
const uint32_t __RL_USBD_VER = 0x470;
#else
...
static __inline BOOL USBD_ReqGetStatus (void) {
  U32 n, m;
...
static __inline BOOL USBD_ReqSetClrFeature (U32 sc) {
  U32 n, m;
...
static __inline BOOL USBD_ReqSetAddress (void) {
...
static __inline BOOL USBD_ReqGetDescriptor (void) {
  U8  *pD;
  U32  len, n;
...
static __inline BOOL USBD_ReqGetConfiguration (void) {
...
static __inline BOOL USBD_ReqSetConfiguration (void) {
...
static __inline BOOL USBD_ReqGetInterface (void) {
...
static __inline BOOL USBD_ReqSetInterface (void) {
