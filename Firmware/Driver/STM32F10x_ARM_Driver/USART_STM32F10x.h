...
#include "USART_Config_USART1_CDC_PA9PA10.h"
#warning "CDC UART: USART1 PA9/PA10 (mutually exclusive with SWO_PB7; SWO UART is disabled)."
#elif defined ( SWO_PB7 )
#include "USART_Config_USART1_Remap.h"   //SWO pin - PB7
#warning "Use PB7 as SWO port."
#elif defined ( SWO_PA10 )
#include "USART_Config_USART1_noRemap.h" //SWO pin - PA10
#warning "Use PA10 as SWO port."
#else
#error "Define exactly one of: CDC_UART_USE_USART1_PA9_PA10, SWO_PA10, SWO_PB7."
#endif
